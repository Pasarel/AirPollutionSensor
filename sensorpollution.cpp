...
#include "uglyroller.cpp"

#include "View_ugly.cpp"
...
class MPSensorEndPoint {
  ...
  private:
    ...
    void setupRoutes() {
      ...
      Routes::Get(router, "/actionCheckWindow/:id?", Routes::bind( & Controller_Manual_Process::checkWindow, &man_proc_cntrl));
      Routes::Get(router, "/actionCloseWindow/:id?", Routes::bind( & Controller_Manual_Process::closeWindow, &man_proc_cntrl));
      Routes::Get(router, "/actionOpenWindow/:id?", Routes::bind( & Controller_Manual_Process::openWindow, &man_proc_cntrl));
      Routes::Get(router, "/actionGetAirQuality/:coords?", Routes::bind( & Controller_Manual_Process::getAirQuality, &man_proc_cntrl));
      Routes::Get(router, "/actionGetPM25/:coords?", Routes::bind( & Controller_Manual_Process::getPM25, &man_proc_cntrl));
